...
<table class="forumline" width="100%" cellpadding="4" cellspacing="1" border="0">
  ...
  <!-- BEGIN searchresults -->
  <tr> 
	<td class="row1" align="center" valign="middle" width="20"><img src="{searchresults.TOPIC_FOLDER_IMG}" alt="{searchresults.L_TOPIC_FOLDER_ALT}" title="{searchresults.L_TOPIC_FOLDER_ALT}" /></td>
