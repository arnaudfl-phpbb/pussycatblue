...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr>
	...
	<td align="right"> 
	  ...
	  <table class="forumline" width="175" cellspacing="1" cellpadding="2" border="0">
		<tr>
		...
		<tr>
		  <td colspan="3" width="175" class="row2"><table cellspacing="0" cellpadding="1" border="0">
			<tr>
			  <td class="mpBar"><img src="{I_SPACER}" width="{INBOX_LIMIT_IMG_WIDTH}" height="8" alt="{INBOX_LIMIT_PERCENT}" /></td>
			</tr>
		  </table></td>
		</tr>
		<tr>
...
<form method="post" name="privmsg_list" action="{S_PRIVMSGS_ACTION}">
  ...
  <table class="forumline" width="100%" cellpadding="3" cellspacing="1" border="0">
	...
	<tr>
	  ...
	  <td class="{listrow.ROW_CLASS}" width="55%" valign="middle"><span class="topictitle"><a href="{listrow.U_READ}" class="topictitle">{listrow.SUBJECT}</a></span></td>
